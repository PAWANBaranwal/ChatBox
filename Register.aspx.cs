...
namespace SignalRChat
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        {
            string Query = "insert into Users(UserName,Email,Password)Values('"+txtName.Value+"','"+txtEmail.Value+"','"+txtPassword.Value+"')";
            string ExistQ = "select * from Users where Email='"+txtEmail.Value+"'";
